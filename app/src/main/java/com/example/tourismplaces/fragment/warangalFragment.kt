...
import com.example.tourismplaces.databinding.FragmentWarangalBinding
import com.example.tourismplaces.model.TourismModel

class warangalFragment : Fragment() {

    private lateinit var binding: FragmentWarangalBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentWarangalBinding.inflate(inflater, container, false)
    ...
    private fun setupRecyclerview() {
        binding.rvWarangal.adapter = TourismAdapter(tourList)
        binding.rvWarangal.layoutManager = LinearLayoutManager(activity)
    }

    private fun generateList(): List<TourismModel> {

        val list = ArrayList<TourismModel>()
        list.add(TourismModel(R.drawable.ic_launcher_background,"warangal fort","this is place1",R.drawable.ic_launcher_background,R.drawable.ic_launcher_background,R.drawable.ic_launcher_background))
